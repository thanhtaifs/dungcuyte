...
//error_log('promotion module - main.php loaded');
global $module_data;
...
$contents = '';
    ...
    //error_log('vao services module - main.php thu muc cha');
...
//error_log('ok promotionmain.php - before include header/footer');
