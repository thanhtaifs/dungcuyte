...
{
	global $module_config, $nv_Request, $lang_module_comment, $module_info, $client_info, $per_page_comment, $admin_info;
...
function nv_comment_module_data( $module, $comment_array, $is_delete )
{
	...
	if( ! empty( $comment_array['comment'] ) )
	{
		foreach( $comment_array['comment'] as $comment_array_i )
		{
			...
			{
				$comment_array_i['photo'] = NV_BASE_SITEURL . 'themes/dungcuytecantho/images/users/no_avatar.jpg';
			}
