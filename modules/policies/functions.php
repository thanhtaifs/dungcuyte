...
if( ! defined( 'NV_SYSTEM' ) ) die( 'Stop fuctions !!!' );
//error_log('policies module fuctions loaded?');
...
//error_log('foreach services module fuctions loaded?');
$id = 0;
$page = 1;
...
//error_log('ok policies module fuctions loaded?');