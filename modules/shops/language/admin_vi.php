...
$lang_module['setting_order_notify_email'] = 'Email nhận đơn hàng';
$lang_module['setting_order_notify_email_note'] = 'Nhập 1 hoặc nhiều email, ngăn cách bằng dấu phẩy hoặc dấu chấm phẩy.';
$lang_module['setting_order_notify_email_error'] = 'Email nhận đơn hàng không hợp lệ: %s';
...
$lang_module['review_edit'] = 'Duyệt và phản hồi đánh giá';
$lang_module['review_moderation_pending'] = 'Chờ duyệt';
$lang_module['review_moderation_approved'] = 'Đã duyệt';
$lang_module['review_moderation_rejected'] = 'Từ chối';
$lang_module['review_verified_purchase'] = 'Xác minh đã mua';
$lang_module['review_verified_purchase_yes'] = 'Đã xác minh';
$lang_module['review_verified_purchase_no'] = 'Chưa xác minh';
$lang_module['review_helpful_count'] = 'Lượt hữu ích';
$lang_module['review_unhelpful_count'] = 'Lượt không hữu ích';
$lang_module['review_seller_response'] = 'Phản hồi từ nhà bán';
$lang_module['review_spam_score'] = 'Điểm spam';
$lang_module['review_edited_count'] = 'Số lần chỉnh sửa';
$lang_module['review_rejection_reason'] = 'Lý do từ chối';
