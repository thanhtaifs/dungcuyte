...
define( 'NV_MAX_REQUESTS_60', 3000);
 
//So requests toi da trong 5 phut
define( 'NV_MAX_REQUESTS_300', 12000 );


// Cho phép số lần submit form trong 1 phút
define('NV_MAX_SUBMIT', 999999);

// Thời gian tính submit (giây)
define('NV_MAX_SUBMIT_TIME', 1);

// Cho phép số lần load module trong 1 phút
define('NV_MAX_MODLOAD', 999999);

// Thời gian tính load module (giây)
define('NV_MAX_MODLOAD_TIME', 1);

// Thời gian delay mặc định khi nghi ngờ flood (giây)
define('NV_FLOOD_DELAY', 0);

// Số IP ghi nhớ trong bảng flood (0 = tắt lưu)
define('NV_FLOOD_IP_SAVE', 0);

define('NV_MAX_LOGIN', 999999);
define('NV_MAX_LOGIN_TIME', 1);
