...
function nv_error_info()
{
	...
	else
	{
		...
		$image_path = NV_BASE_SITEURL . 'themes/dungcuytecantho/images/icons/';
	}
...
function nv_rss_generate( $channel, $items )
{
	...
	$xtpl = new XTemplate( 'rss.tpl', NV_ROOTDIR . '/themes/dungcuytecantho/layout/' );
	$xtpl->assign( 'CSSPATH', NV_BASE_SITEURL . 'themes/dungcuytecantho/css/rss.xsl' );
...
function nv_xmlSitemap_generate( $url )
{
	...
	{
		$path_css_sitemap = NV_BASE_SITEURL . 'themes/dungcuytecantho/css/sitemap.xsl';
	}
...
function nv_xmlSitemapIndex_generate()
{
	...
	{
		$path_css_sitemap = NV_BASE_SITEURL . 'themes/dungcuytecantho/css/sitemapindex.xsl';
	}
