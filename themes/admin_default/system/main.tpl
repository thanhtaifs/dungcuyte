...
<div class="container-fluid nvwrap">
	...
	<header id="header" class="row d-flex justify-content-between align-items-center">
		<div class="logo">
	...
	<div class="row">
		<div class="navbar navbar-expand-lg navbar-light bg-light w-100" role="navigation">
			<div class="container-fluid">
			    <!-- Nút toggle menu -->
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#menu-horizontal" aria-controls="menu-horizontal" aria-expanded="false" aria-label="Toggle navigation">
				...
				<nav  class="collapse navbar-collapse d-flex align-items-center w-100" id="menu-horizontal">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item-home">
							<a title="{LANG.Home}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
							    <em class="fa fa-lg fa-home mr-1">&nbsp;</em> {LANG.Home}</a>
						</li>
						<!-- BEGIN: top_menu_loop -->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={TOP_MENU_HREF}">{TOP_MENU_NAME}<!-- BEGIN: has_sub --> <strong class="caret">&nbsp;</strong><!-- END: has_sub --></a>
							<!-- BEGIN: submenu -->
							<div class="dropdown-menu">
								<!-- BEGIN: submenu_loop --><a class= "dropdown-item" href="{SUBMENULINK}" title="{SUBMENUTITLE}">{SUBMENUTITLE}</a><!-- END: submenu_loop -->
							</div>
							<!-- END: submenu -->
						</li>
						<!-- END: top_menu_loop -->
					</ul>
					<p class="navbar-text mb-0" id="digclock">{NV_DIGCLOCK}</p>
				</nav>
			</div>
		</div>
	</div>
	<section id="middle" class="row">
		<aside id="left-menu">
			<div id="bg-left-menu" style="padding-right: 20px;padding-left: 4px;width: 200px;">
				<ul class="nav flex-column text-color">
					<!-- BEGIN: menu_loop -->
						<li {MENU_CLASS}>
