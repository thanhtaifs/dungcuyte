...
$(document).ready(function(){
	$('.navbar-default .navbar-toggle' ).click(function() {
	  $('#wraper nav').toggleClass('show-bg');
	});
	...
	widhtbody = $('body').width();

	if(widhtbody < 992){
		$('#body .col-sm-8 .right-top .panel-heading').click(function() {
		  $('#body .col-sm-8 .right-top .panel-body').toggleClass('show');
		});
	}	
});
;