<!-- BEGIN: main -->
<div class="content-page-list content-page-list--promotion">
    <div class="content-hero">
        <div class="content-hero__eyebrow">Khuyến mãi</div>
        <h1 class="content-hero__title">Ưu đãi và chương trình nổi bật</h1>
        <p class="content-hero__text">Cập nhật nhanh các chương trình khuyến mãi, ưu đãi theo mùa và những thông tin nổi bật dành cho khách hàng.</p>
    </div>
