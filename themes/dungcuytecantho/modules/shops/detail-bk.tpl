...
<div id="detail" class="shop-detail">
	<div class="panel">
		<div class="panel-body">
			<div class="row">
				<div class="col-xs-24 col-sm-10 text-center images-thumb">
					<img src="{SRC_PRO}" alt="" width="300px" id="imageproduct" data-target="#imagemodal">
            <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="col-xs-24 col-sm-12 content-detail">
					<ul class="product_info">
						...
						<li class="price">
							<p>
								...
								<!-- BEGIN: no_discounts -->
								<span class="money t">{PRICE.price_format} {PRICE.unit}</span>
								<!-- END: no_discounts -->
							</p>
						</li>
						<!-- END: price -->
					...
					<div class="socaial-share">
						...
						<a class="button_share share facebook" href="https://www.facebook.com/sharer/sharer.php?u={SELFURL}" target="_blank"><i class="fa fa-facebook"></i> Share</a>
