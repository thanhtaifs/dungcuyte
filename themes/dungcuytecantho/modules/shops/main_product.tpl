                ...
                <div class="col-12 col-sm-6 col-md-3">
                        <div class="thumbnail">
                            <div class="image_center">
                                <a href="{LINK}" title="{TITLE}"><img src="{IMG_SRC}" alt="{TITLE}" data-content='{hometext}' data-rel="tooltip" class="img-thumbnail" loading="lazy" decoding="async" width="500" height="500"></a>
                            </div>
